...
description: An opinionated UnoCSS preset featuring advanced animations, fluid typography, Magic CSS integration, custom scrollbars, and seamless Akar design system support.
...
We utilize [UnoCSS preflights](https://unocss.dev/config/preflights) to apply a CSS reset, ensuring consistent styling across all browsers.
...
| [transformerVariantGroup](https://unocss.dev/transformers/variant-group) | Enables the variant group feature for UnoCSS. |

### Presets

This is the list of available presets included in `presetVinicunca`. Not all of them are enabled by default so you need to enable them manually if you want to use them. Please refer to the [Options](#options) section for more information.

| Preset | Description | Enabled by default |
| --- | --- | --- |
| [presetWind4](https://unocss.dev/presets/wind4) | The Tailwind4 CSS compact preset for UnoCSS. | ✅ |
| [presetWind3](https://unocss.dev/presets/wind3) | The Tailwind3 CSS compact preset for UnoCSS. | ❌ |
...
| [presetAnimation](/unocss-preset/animations/usage) | An animation preset inspired by tailwind-animate. | ✅ |
| [presetFluid](/unocss-preset/fluid/usage) | Offers an elegant solution to scale typography and spacing fluidly across different screen sizes without the need for breakpoints. | ✅ |
| [presetScrollbar](/unocss-preset/scrollbar/usage) | A customizable scrollbar preset for UnoCSS. | ❌ |
| [presetAkar](/unocss-preset/akar/usage) | Seamless integration with the Akar design system. | ❌ |
...
| Name | Link |
| --- | --- |
| **Animations** | [AnimationOptions and VinicuncaExtends](/unocss-preset/animations/usage) |
| **Fluid** | [FluidOptions](/unocss-preset/fluid/usage) |
| **Akar** | [VinicuncaAkarOptions](/unocss-preset/akar/usage) |
| **Scrollbar** | [UnoPresetScrollbarOption](/unocss-preset/scrollbar/usage) |
| **MagicCSS** | [MagicssOptions](/unocss-preset/magic-css/usage) |
...
::tip{to="/unocss-preset/theme"}
To make animation configuration more flexible and easier to use, we have extended the UnoCSS theme to support easier animation configuration similar to Tailwind CSS.
::
